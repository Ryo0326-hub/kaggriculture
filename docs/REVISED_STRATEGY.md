...
**Current next-step plan:** the subsequent [Step 6 server and leader audit](STEP_6_SERVER_AND_LEADER_ANALYSIS.md) confirms the uploaded mixed agent and motivates [joint opening and dated production bundles](STEP_7_PLAN.md). That staged plan supersedes the immediate priorities below. This document preserves the earlier strategy and its evidence.
