...
| Step 7 | `5ec112bd59eae75b2da53b4a35754a1d9c4261a6eb35677fef0b1d231e5b7a41` | ID not supplied | Uploaded by user; ladder episodes `107666399` and `107668390` reproduce exactly and match the source |
| Step 8 | `63dbf4381d8607cbd681f5296749f4f8af4cc37d0181f97d6b8931f6078d3f72` | Not uploaded | Ready for upload: 353/360 fresh-pool wins, positive paired comparison, isolated artifact and serial runtime diagnostics passed |
...
Step 7 was subsequently uploaded by the user. Its two supplied ladder games confirm execution, not medal strength. The current latest-two registry has not been re-queried. Step 8 has not been uploaded during this implementation; [its results](STEP_8_RESULTS.md) distinguish local validation from server status.
