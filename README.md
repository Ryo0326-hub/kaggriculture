...
**New submission candidate: Cycle 21 — production calendars and deadline-aware service.** A complete standalone descendant of the preserved Cycle 20. It skips safe watering days, retains production-night input service, assigns nearby workers before survival/decay deadlines and charges crop investments for the new work calendar. Final artifact: `artifacts/submission-cycle-21-final/main.py`, SHA-256 `f56a3f597528…`. It passes 176 bounded tests and 5,752 independent recorded-observation checks; no local games were run. **Kaggle validation and competitive performance are pending.** [Upload command](docs/CYCLE_21_RESULTS.md) · [Implementation and CO notes](docs/CYCLE_21_OPTIMIZATION.md). [Preserved Cycle 20 release](docs/CYCLE_20_RESULTS.md).
