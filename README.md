...
**New submission candidate: Cycle 20 — supply risk and survival deadlines.** A bounded descendant of the submitted Cycle 19, prompted by Majkel’s 3,119-coin loss to M & M & P & Q. It prices committed output on its production dates, accounts for grain used as feed, removes optimistic cushioning of predicted price collapses and prioritizes late-day survival. Final artifact: `artifacts/submission-cycle-20-final/main.py`, SHA-256 `79a8fb9661cd…`. It passes 117 bounded tests and 7,190 independent recorded-observation checks. **Competitive performance and Kaggle validation are unmeasured.** [Upload command](docs/CYCLE_20_RESULTS.md) · [Implementation and CO notes](docs/CYCLE_20_OPTIMIZATION.md) · [Replay study](docs/MAJKEL_108295517_STUDY.md).

**Preserved Cycle 19:** the user reports submitting `eb151fe1e088…`; no own Cycle 19 server replay has been supplied yet. Its source and artifact remain unchanged. [Cycle 19 release](docs/CYCLE_19_RESULTS.md).
